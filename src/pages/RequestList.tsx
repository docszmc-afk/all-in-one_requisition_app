      ...
      <div className="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
        <div className="p-4 sm:p-6 border-b border-stone-100 flex flex-col sm:flex-row gap-4 justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
            ...
            <div className="flex items-center space-x-2 w-full sm:w-auto">
              <Filter className="w-5 h-5 text-stone-400 sm:hidden" />
              <select
                value={statusFilter}
                onChange={(e) => {
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col items-start gap-1">
                        ...
                        {req.status === 'Pending Approval' && req.currentApproverIndex !== undefined && req.workflow && (
                          <span className="text-[10px] font-medium text-stone-500 bg-stone-100 px-2 py-0.5 rounded-full border border-stone-200">
                            with {MOCK_USERS.find(u => u.id === req.workflow![req.currentApproverIndex!])?.department || 'Unknown'}
                          </span>
                        )}
                      </div>
                    </td>
          ...
          <div className="px-6 py-4 border-t border-stone-200 flex items-center justify-between bg-stone-50">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="p-2 rounded-lg border border-stone-200 bg-white text-stone-500 hover:bg-stone-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
