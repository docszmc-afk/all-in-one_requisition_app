...
export interface ProcurementRequest {
  ...
  audit1PhysicallySeen?: boolean;
  audit1PhysicallySeenAt?: string;
  audit1ReminderSentAt?: string;
  audit2PhysicallySeen?: boolean;
  audit2PhysicallySeenAt?: string;
  audit2ReminderSentAt?: string;
}
